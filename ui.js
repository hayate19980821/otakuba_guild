window.GuildUI = (() => {
  ...
  function renderNotice(settings){ const box=$('noticeBox'); if(!box)return; const n=settings.notice || {}; if(!n.enabled){ box.innerHTML=''; return; } box.style.order = n.position === 'bottom' ? '2' : '-1'; box.innerHTML = `<div class="panel notice"><b class="goldtxt">📢 ${esc(n.title || '本日のお知らせ')}</b><div class="mt">${esc(n.body || '現在、お知らせはありません').replace(/\n/g,'<br>')}</div></div>`; }
